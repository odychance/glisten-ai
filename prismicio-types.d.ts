...
type CaseStudyDocumentDataSlicesSlice = RichTextSlice | CaseStudiesSlice;
...
/**
 * Item in *Bento → Default → Primary → Group*
 */
export interface BentoSliceDefaultPrimaryGroupItem {
  /**
   * Title field in *Bento → Default → Primary → Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.group[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.group[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Group*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.group[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Group*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.group[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Group field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  group: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryGroupItem>>;
}
...
/**
 * Item in *CaseStudies → Default → Primary → group*
 */
export interface CaseStudiesSliceDefaultPrimaryGroupItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → group*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.group[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * group field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  group: prismic.GroupField<Simplify<CaseStudiesSliceDefaultPrimaryGroupItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryGroupItem,
      ...
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryGroupItem,
